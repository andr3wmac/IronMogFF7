...
{
    CONST_PTR Allies[] = { 0xF5BBA, 0xF5BFE, 0xF5C42 };
    CONST_PTR Enemies[] = { 0xF5CCA, 0xF5D0E, 0xF5D52, 0xF5D96, 0xF5DDA, 0xF5E1E };

    CONST_PTR ATBRate   = 0x00;
    CONST_PTR ATB       = 0x02;
    CONST_PTR HPDisplay = 0x3A;
};

struct BattleSceneOffsets
{
    CONST_PTR SceneStart    = 0xF5CAC;
    CONST_PTR AttackIDList  = 0x840; // fixed-size array of 32 uint16_t
    CONST_PTR AttackNames   = 0x880; // fixed-size array of 32 of 32-byte FF7 strings
    ...
    // Per-enemy (relative to each Enemies[] entry):
    CONST_PTR EnemyAttackIDs = 0x48; // fixed-size array of 16 uint16_t attack IDs (0xFFFF = none)
