...
std::vector<std::string> BanItemsAndMateria::describe(ModDescriptionType descType)
{
    if (descType == ModDescriptionType::BanItems)
    {
    ...
    if (descType == ModDescriptionType::BanMateria)
    {
        std::vector<std::string> results;
